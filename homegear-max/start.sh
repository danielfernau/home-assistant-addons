...
# based on https://github.com/Homegear/Homegear-Docker/blob/master/nightly/start.sh
# and https://github.com/kreativmonkey/hassio-addons/blob/master/homegear/script/run.sh
